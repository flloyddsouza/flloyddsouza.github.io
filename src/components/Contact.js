...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (name.length === 0 || email.length === 0 || message.length === 0) {
      ...
      emailjs
        .send(
          "service_l0qxe7g", // service id
          "template_jgd7qjf", // template id
          mailData,
          "XSSgQI0BMAyF_Jfs2" // public api
        )
        .then(
          (response) => {
            setError(false);
        ...
        <div className="container">
          ...
          <div className="contact_inner">
            <div className="left wow fadeInLeft" data-wow-duration="1s">
              <div className="text">
                <p>
                  Please fill out the form to contact me or call between 9:00 AM and 5:00 PM, Monday through
                  Friday
                </p>
              </div>
              <ul>
